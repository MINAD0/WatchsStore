        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-5">
                <div class="contact-info">
                    ...
                    <h3><i class="fa fa-map-marker"></i>sidi maarouf, Casablanca, MA</h3>
                    <h3><i class="fa fa-envelope"></i>al0mahdi.ait1ounzar@gmail.com</h3>
                    <h3><i class="fa fa-phone"></i>+212 654220539</h3>
...
<div id="footer">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <p>&copy; Copyright <a href="https://github.com/minado22">MINADO</a>. All Rights Reserved</p>
            </div>
            {{-- <div class="col-md-6">
