                        ...
                        <tr>
                                ...
                                <div class="product-info">
                                    ...
                                    <div>
                                        ...
                                        <form action="{{route('remove', $product['id'])}}" method="POST">
                                            ...
                                            <input type="submit" name="remove_btn" class="remove-btn" style="color: red; font-weight: 800;" value="remove">
                                        </form>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <form action="{{route('edit_quantity')}}"  method="POST">
                                    @csrf
                                    <input type="submit" value="-" style="color: #407088; font-weight: bold;" class="edit-btn" name="decrease_product_quantity_btn">
                                    <input type="hidden" name="id" value="{{$product['id']}}" readonly>
                                    <input type="text" name="quantity" value="{{$product['quantity']}}">
                                    <input type="submit" value="+" style="color: #407088; font-weight: 800;" class="edit-btn" name="increase_product_quantity_btn">
                                </form>
                            </td>
